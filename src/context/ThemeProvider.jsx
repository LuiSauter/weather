...
import { getTheme, disableAnimation, getSystemTheme, MEDIA } from './helpers'

const colorSchemes = ['light', 'dark']
const ThemeContext = createContext(undefined)
const defaultContext = { setTheme: () => { /** void */ }, themes: [] }
...
const Theme = ({
  ...
  /** @description set theme string into local storage */
